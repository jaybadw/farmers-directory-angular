...
export class CategoryService {
  ...
  private REST_API_URL = "https://farmers-directory.vercel.app/api/v1/categories"
  ...
  getCategoryById(id:string): Observable<categories | any>{
    ...
    return this.http.get<categories>(thisUrl,{headers:this.HTTP_HEADER}).pipe(
      tap(categories =>{
  ...
  getAllCategories(){
    ...
    return this.http.get<categories[]|any>(thisUrl,{headers:this.HTTP_HEADER}).pipe(
      tap(categories =>{
